...
function(SkyUI_AS_Add)
    ...
    if(ARG_XML_PATH)
        set(_XML_SOURCE "${CMAKE_CURRENT_SOURCE_DIR}/source/actionscript/${ARG_XML_PATH}")
    else()
        get_filename_component(_SWF_REL_DIR "${ARG_SWF_REL}" DIRECTORY)
        get_filename_component(_SWF_REL_WE  "${ARG_SWF_REL}" NAME_WE)
        if(_SWF_REL_DIR)
            set(_XML_SOURCE "${CMAKE_CURRENT_SOURCE_DIR}/source/actionscript/${_SWF_REL_DIR}/${_SWF_REL_WE}.xml")
        else()
            set(_XML_SOURCE "${CMAKE_CURRENT_SOURCE_DIR}/source/actionscript/${_SWF_REL_WE}.xml")
        endif()
    endif()

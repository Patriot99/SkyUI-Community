class InputMappingArt extends MovieClip
{
   ...
   {
      this.textField._visible = false;
      var _loc3_ = this._buttonNameMap[a_buttonName.toLowerCase()];
      if(_loc3_ instanceof Array)
      {
         this._keyCodes = _loc3_;
      }
      else
      {
         this._keyCodes = [_loc3_];
      ...
      {
         _loc4_ = 0;
         while(_loc4_ < this.buttonArt.length)
         {
            this.buttonArt[_loc4_]._visible = false;
            _loc4_ += 1;
         }
      ...
      while(_loc4_ < this.buttonArt.length)
      {
         _loc6_ = this.buttonArt[_loc4_];
         if(this._keyCodes[_loc4_] > 0)
         {
            _loc6_._visible = true;
            _loc6_.gotoAndStop(this._keyCodes[_loc4_]);
            _loc6_._x = _loc5_;
            _loc6_._y = 0;
            _loc5_ += _loc6_._width;
         }
         else
         {

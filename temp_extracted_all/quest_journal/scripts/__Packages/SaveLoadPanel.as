class SaveLoadPanel extends MovieClip
{
   ...
   function onSaveLoadItemPress(event)
   {
      ...
      if(this.isShowingCharacterList)
      {
         ...
         if(_loc3_ != undefined)
         {
            ...
            gfx.io.GameDelegate.call("CharacterSelected",[_loc5_,_loc4_,this.bSaving,this.SaveLoadList_mc.entryList,this.iBatchSize]);
   ...
   function onFillCharacterListComplete(abDoInitialUpdate)
   {
      ...
      var _loc3_ = 20;
      var _loc4_ = 0;
      while(_loc4_ < this.SaveLoadList_mc.entryList.length)
      {
         if(this.SaveLoadList_mc.entryList[_loc4_].text.length > _loc3_)
         {
            this.SaveLoadList_mc.entryList[_loc4_].text = this.SaveLoadList_mc.entryList[_loc4_].text.substr(0,_loc3_ - 3) + "...";
         }
         _loc4_ += 1;
      }
   ...
   function onSaveLoadBatchComplete(abDoInitialUpdate, aNumProcessed, aSaveCount)
   {
      ...
      var _loc6_ = 0;
      while(_loc6_ < this.SaveLoadList_mc.entryList.length)
      {
         if(this.iPlatform == SaveLoadPanel.CONTROLLER_ORBIS)
         {
            if(this.SaveLoadList_mc.entryList[_loc6_].text == undefined)
            {
               this.SaveLoadList_mc.entryList.splice(_loc6_,1);
            }
         }
         if(this.SaveLoadList_mc.entryList[_loc6_].text.length > _loc5_)
         {
            this.SaveLoadList_mc.entryList[_loc6_].text = this.SaveLoadList_mc.entryList[_loc6_].text.substr(0,_loc5_ - 3) + "...";
         }
         _loc6_ += 1;
      }
      var _loc7_ = "$[NEW SAVE]";
      var _loc8_;
      if(this.bSaving && this.SaveLoadList_mc.entryList[0].text != _loc7_)
      {
         _loc8_ = {name:" ",playTime:" ",text:_loc7_};
         this.SaveLoadList_mc.entryList.unshift(_loc8_);
      }
      else if(!this.bSaving && this.SaveLoadList_mc.entryList[0].text == _loc7_)
      {

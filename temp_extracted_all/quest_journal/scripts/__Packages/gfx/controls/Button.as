class gfx.controls.Button extends gfx.core.UIComponent
{
   ...
   function alignForAutoSize()
   {
      ...
      var _loc3_ = this._x + _loc2_ / 2;
      this._x = _loc3_ - this.__width / 2;
      return undefined;
   }
   function setState(state)
   {
      ...
      var _loc4_ = this.stateMap[state];
      ...
      do
      {
         _loc3_ = _loc5_.pop().toString();
         _loc2_ = _loc4_.length - 1;
         while(_loc2_ >= 0)
         {
            this.gotoAndPlay(_loc3_ + _loc4_[_loc2_]);
            _loc2_ = _loc2_ - 1;
         }
      }

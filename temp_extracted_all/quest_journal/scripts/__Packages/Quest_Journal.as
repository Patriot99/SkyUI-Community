class Quest_Journal extends MovieClip
{
   ...
   function handleInput(details, pathToFocus)
   {
      ...
      var _loc5_;
      var _loc6_;
      if(!_loc4_ && Shared.GlobalFunc.IsKeyPressed(details,false))
      {
         _loc5_ = gfx.ui.NavigationCode.GAMEPAD_L2;
         _loc6_ = gfx.ui.NavigationCode.GAMEPAD_R2;
         if(SystemPage(this.PageArray[Quest_Journal.PAGE_SYSTEM]).GetIsRemoteDevice())
         {
            _loc5_ = gfx.ui.NavigationCode.GAMEPAD_L1;
            _loc6_ = gfx.ui.NavigationCode.GAMEPAD_R1;
         }
         ...
         else if(details.navEquivalent === _loc5_)
         {
            if(!this.bTabsDisabled)
            {
               ...
               this.iCurrentTab += details.navEquivalent != _loc5_ ? 1 : -1;
         ...
         else if(details.navEquivalent === _loc6_)
         {
            if(!this.bTabsDisabled)
            {
               this.PageArray[this.iCurrentTab].endPage();
   ...
   function onTabClick(event)
   {
      ...
      if(_loc3_ != this.iCurrentTab)
      {
         this.PageArray[_loc3_].endPage();
         this.SwitchPageToFront(this.iCurrentTab,false);
      }
   }

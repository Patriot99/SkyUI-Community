      ...
      if(Shared.GlobalFunc.IsKeyPressed(details))
      {
         switch(this.iMovieType)
         {
            ...
            case 1:
               ...
               {
                  _loc4_ = this.OptionStepper_mc.handleInput(details,pathToFocus);
               }
               break;
            case 2:
   ...
   function onMousePress()
   {
      ...
      switch(this.iMovieType)
      {
         case 0:
            ...
            if(_loc2_._parent == this.ScrollBar_mc.upArrow)
            {
               this.ScrollBar_mc.upArrow.onPress();
               return;
            }
            if(_loc2_._parent == this.ScrollBar_mc.downArrow)
            {
               this.ScrollBar_mc.downArrow.onPress();
               return;
            }
            if(_loc2_ == this.ScrollBar_mc.track)
            {
         ...
         case 1:
            ...
            if(_loc2_ == this.OptionStepper_mc.prevBtn)
            {

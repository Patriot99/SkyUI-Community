class gfx.controls.TextArea extends gfx.controls.TextInput
{
   ...
   function handleInput(details, pathToFocus)
   {
      ...
      var _loc4_ = details.controllerIdx;
      if(Selection.getFocus(_loc4_) == null)
      {
         Selection.setFocus(this.textField,_loc4_);
         return true;
      }
      if(this._editable)
      {
      ...
      if(__reg0 === gfx.ui.NavigationCode.PAGE_UP)
      {
         ...
         this.position = Math.max(1,this.position - _loc2_);
         return true;
      }
      if(__reg0 === gfx.ui.NavigationCode.PAGE_DOWN)
      {
         _loc2_ = this.textField.bottomScroll - this.textField.scroll;
         this.position = Math.min(this.maxscroll,this.position + _loc2_);
         return true;
      }
      return false;
   }
   ...
   function updateScrollBar()
   {
      ...
      {
         _loc2_ = this.constraints.getElement(this.textField);

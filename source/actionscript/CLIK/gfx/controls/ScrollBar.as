class gfx.controls.ScrollBar extends gfx.controls.ScrollIndicator
{
   ...
   function updateThumb()
   {
      ...
      var _loc7_ = Math.max(1,this.maxPosition - this.minPosition + this.pageSize);
      var _loc2_ = this.track.height + this.offsetTop + this.offsetBottom;
      var _loc6_ = _loc2_;
      this.thumb.height = Math.max(10,Math.min(_loc2_,this.pageSize / _loc7_ * _loc6_));
      var _loc4_ = (this._position - this.minPosition) / (this.maxPosition - this.minPosition);
      var _loc3_ = this.track._y - this.offsetTop;
      var _loc5_ = _loc4_ * this.availableHeight + _loc3_;
      this.thumb._y = Math.max(_loc3_,Math.min(this.track._y + this.track.height - this.thumb.height + this.offsetBottom,_loc5_));
      this.thumb.visible = !(isNaN(_loc4_) || this.maxPosition <= 0 || this.maxPosition == Infinity);
   ...
   function trackScroll()
   {
      ...
      var _loc2_ = this.position < this.trackScrollPosition ? this.trackScrollPageSize : - this.trackScrollPageSize;
      var _loc3_ = this.position + _loc2_;
      this.position = _loc2_ < 0 ? Math.max(_loc3_,this.trackScrollPosition) : Math.min(_loc3_,this.trackScrollPosition);
   }
